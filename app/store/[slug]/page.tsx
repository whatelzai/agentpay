        ...
        {product.hiddenPayload ? (
          <div className="mt-8 grid gap-4 sm:grid-cols-2">
            ...
            >
              ...
              <p className="my-3 text-sm leading-relaxed text-[#432b21]/75">
                Sign the same {product.name}. This scripted fallback replays the
                hidden page instruction deterministically, so AgentPay refuses
                the mismatch every time. The live attack is a recorded
